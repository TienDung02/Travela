...
class RoleSeeder extends Seeder
{
    public function run(): void
    {
        Role::insert([
            ...
            ['name' => 'Product manager', 'desc' => 'Order and payment management'],
            ...
            ['name' => 'Category', 'desc' => 'Book tours, travel packages, use AI to create itineraries, view information about company, websites and tourist destinations'],
        ]);
    }
}
