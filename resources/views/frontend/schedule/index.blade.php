                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body h-100">
                        <div class="row h-100">
                                ...
                                <div id="carouselExample" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img id="modal-main-image" src="{{ asset('frontend/images/image-coming-soon.jpg') }}" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img id="modal-night-image" src="{{ asset('frontend/images/image-coming-soon.jpg') }}" class="d-block w-100" alt="...">
                                        </div>
                                    </div>
                            ...
                            <div class="col-6 h-100 overflow-auto" style="max-height: 70vh;" >
