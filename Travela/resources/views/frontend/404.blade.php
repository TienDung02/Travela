            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="about/index.blade.php" class="nav-item nav-link">About</a>
                        <a href="services/index.blade.php" class="nav-item nav-link">Services</a>
                        <a href="packages.html" class="nav-item nav-link">Packages</a>
                        <a href="blog/index.blade.php" class="nav-item nav-link">Blog</a>
                        ...
                        <a href="contact/index.blade.php" class="nav-item nav-link">Contact</a>
                    </div>
